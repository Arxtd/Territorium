...
import { Save, X, Users, HelpCircle } from 'lucide-react'
...
const MapEdit = () => {
  ...
  // Buscar o mapa geral (congregacao)
...
const AssignDirigentesModal = ({ dirigentes, assignedIds, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 dark:bg-black dark:bg-opacity-90 overflow-y-auto h-full w-full z-50">
